	...
	<tr align="center" bgcolor="#D5D5D5">
					...
					%>
							<tr style="height: 40px; line-height: 40px;">
								...
								<a id="submit_adjust_link"  onclick="return show_confirm('确认设置为爽约？');" href="../admin/set_reservation_status.jsp?type=unvisited&clinic_reservation_id=<%=reservation_dao.outpatient_doctor_id.get(i) %>" ><big>爽约</big></a>
								<a id="submit_adjust_link"  onclick="return show_confirm('确认设置为履约？');" href="../admin/set_reservation_status.jsp?type=visited&clinic_reservation_id=<%=reservation_dao.outpatient_doctor_id.get(i) %>" ><big>履约</big></a>
