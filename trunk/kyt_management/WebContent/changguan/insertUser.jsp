...
<form class="form-horizontal" id="userForm" method="post" action="../changguan/editUserInfo.jsp?type=new">
	...
	<div class="view" style="width:100%"> 
       ...
       <div align="right">
       <a id="myModalLinkUser" href="#myModalContainerUser" role="button" class="btn btn-primary" data-toggle="modal" contenteditable="true">新建场馆用户</a> 
       </div>
       <!-- Modal -->
       <div id="myModalContainerUser" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabelUser" aria-hidden="true">
         <div class="modal-header">
           ...
           <h3 style="float: left;margin: 10px;" id="myModalLabelUser" contenteditable="true">新建场馆用户</h3>
         </div>
