...
<%@page import="database.*" %>
						...
						<table width="90%">
							<tr>
								...
								出诊时间管理</div></td>
											<td><div class=" btn btn-primary btn-block" 
								onclick="show_hidden('reservation_record_manage','outpatient_time_manage','reservation_category_manage','doctor','patient','changguan','xuetang','beixuan');">
								预约记录管理</div></td>
...
<OPTION  value="针推科">针推科</OPTION>
							...
							<td ><INPUT id="u92" type=text value="医生姓名" class="u92"     ><td >

<td ><INPUT id="u93" type="submit" class="u93" value="查询"   ><td >

<td ><INPUT id="u93" type="submit" class="u93" value="删除"   ><td >

<td ><INPUT id="u94" type="submit" class="u94" value="添加排期"  onclick="ShowModalWithResult('../admin/add_outpatient_info.jsp?type=add','600px','800px');;return false"" ><td >
										</tr>
